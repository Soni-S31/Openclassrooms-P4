/*! jQuery v2.1.0 | (c) 2005, 2014 jQuery Foundation, Inc. | jquery.org/license */ !(function (
                        ...
                        for (b in a)
                            (c = g[b]),
                                ...
                                g !== d &&
                                    (j &&
                                    d &&
                                    (o.isPlainObject(d) || (e = o.isArray(d)))
                                        ? (e
                                              ? ((e = !1),
                                                (f =
                                                    c && o.isArray(c) ? c : []))
    ...
    var Q = /[+-]?(?:\d*\.|)\d+(?:[eE][+-]?\d+|)/.source,
        ...
        S = function (a, b) {
            return (
                (a = b || a),
                "none" === o.css(a, "display") ||
                    !o.contains(a.ownerDocument, a)
            );
        },
        T = /^(?:checkbox|radio)$/i;
    !(function () {
                            ...
                            (k = o.extend(
                                {
                                    ...
                                    selector: e,
                                    needsContext:
                                        e && o.expr.match.needsContext.test(e),
                                    namespace: p.join("."),
                                },
                                f
                            )),
                ...
                while ((f = h[b++]) && !a.isPropagationStopped()) {
                    ...
                    while (
                        ...
                        (!a.namespace_re || a.namespace_re.test(g.namespace)) &&
                            ...
                            (a.data = g.data),
                            (e = (
                                (o.event.special[g.origType] || {}).handle ||
                                g.handler
                            ).apply(f.elem, i)),
                            void 0 !== e &&
                                (a.result = e) === !1 &&
        ...
        o.fn.extend({
            ...
            domManip: function (a, b) {
                ...
                if (
                    ...
                    for (
                        f = o.map(ob(c, "script"), kb), g = f.length;
                        k > j;
                        j++
                    )
                        (h = c),
        ...
        return (
            c ||
                ...
                ("none" !== c && c) ||
                    ((qb = (
                        qb ||
                        o("<iframe frameborder='0' width='0' height='0'/>")
                    ...
                    void 0 === c
                        ...
                        : ((f = typeof c),
                          "string" === f &&
                              (e = Bb.exec(c)) &&
                              ((c =
                                  (e[1] + 1) * e[2] + parseFloat(o.css(a, b))),
                              (f = "number")),
                          null != c &&
                              c === c &&
        ...
        ajax: function (a, b) {
            ...
            (i = k.global),
                ...
                k.ifModified &&
                    ...
                    o.etag[d] &&
                        v.setRequestHeader("If-None-Match", o.etag[d])),
            ...
            function x(a, b, f, h) {
                ...
                2 !== t &&
                    ...
                    (v.statusText = (b || x) + ""),
                    j
                        ? n.resolveWith(l, [r, x, v])
                        : n.rejectWith(l, [v, x, s]),
                    v.statusCode(q),
                    (q = void 0),
                    i &&
                ...
                o
                    ...
                    .done(function (a) {
                        (f = arguments),
                            g.html(
                                d
                                    ? o("<div>").append(o.parseHTML(a)).find(d)
                                    : a
                            );
                    })
                    .complete(
